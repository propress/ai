...
|----------|------|:------:|:------:|:--------:|----------|
| **InMemory** | 内置 | ❌ | ❌ | ❌ | 测试/开发 |
| **Cache** | `symfony/ai-cache-message-store` | 取决于驱动 | 取决于驱动 | ✅ | 简单部署 |
| **Session** | `symfony/ai-session-message-store` | ❌ | ❌ | 随 Session | Web 应用 |
| **Redis** | `symfony/ai-redis-message-store` | ✅ | ✅ | 可配置 | 高并发生产 |
| **Doctrine** | `symfony/ai-doctrine-message-store` | ✅ | ✅ | ❌ | 已有数据库 |
| **MongoDB** | `symfony/ai-mongo-db-message-store` | ✅ | ✅ | ✅ | NoSQL 场景 |
...
| **SurrealDB** | `symfony/ai-surreal-db-message-store` | ✅ | ✅ | ❌ | 多模型数据库 |
